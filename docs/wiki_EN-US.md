...
To begin you must make a fork of the project to do this go [here](https://github.com/DieuDeLaMort/NationsOfWorld).
...
Now that the web server is installed and functional, we must now install the launcher backend. To do this, go to the [the web branch of the project](https://github.com/DieuDeLaMort/NationsOfWorld/tree/WEB-Folder). 
